...
const Pagination = ({ currentPage, totalItems, perPage, renderPageLink }) => {
    ...
    return (
        <div className="pager">
            ...
            <Link key="pagination-item-next" href={currentPage < pages.length ? renderPageLink( parseInt(currentPage) + 1 ) : renderPageLink( currentPage )} className="next page-numbers onovo-next onovo-hover-2"><i className="icon-arrow" /></Link>
            }
        </div>
    );
  };
