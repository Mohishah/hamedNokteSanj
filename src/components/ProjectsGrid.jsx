...
const ProjectsGrid = ({ projects, category, layout, cols, sideFilter, masonry, galleryMode }) => {
  // Isotope
                        ...
                        <div className={!sideFilter ? "onovo-filter js-onovo-filter filter--default" : "onovo-filter js-onovo-filter"}>
                            ...
                            <ul>
                                ...
                                <li key={`categories-item-${key}`}>
                                    <button onClick={handleFilterKeyChange(item.title)} className="onovo-filter-item" type="button" data-filter={item.title}>
