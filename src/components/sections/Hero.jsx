			...
			<section className="onovo-section onovo-hero">
				<div className="image">
					<video autoPlay muted={!mute} loop playsInline id="heroVideo">
						<source src={home.hero.video_url} type="video/mp4" />
					</video>
				...
				<div className="container">
					<h1 className="title onovo-text-white">
						<span data-splitting data-onovo-scroll>
                            <span dangerouslySetInnerHTML={{__html: home.hero.title}} />
                            <span className="onovo-sep word">
								<i className="sep-img" style={{"backgroundImage": "url("+home.hero.image+")"}} />
							</span>
						</span>
					</h1>
					<div className="text">
						<div className="subtitle onovo-text-white">
							<div data-splitting data-onovo-scroll>
                                <div dangerouslySetInnerHTML={{__html: home.hero.subtitle}} />
                            </div>
						</div>
					</div>
