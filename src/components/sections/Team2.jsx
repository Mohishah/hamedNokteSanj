				...
				<div className="container">
					...
					<div className="row gap-row align-center">
						...
						<div className="col-xs-12 col-sm-12 col-md-11 col-lg-5">
							<div className="onovo-heading align-right">
								<div className="onovo-subtitle-1">
									<span>تیم ما</span>
								</div>
								<h2 className="onovo-title-2 mt-5">
                                    <span dangerouslySetInnerHTML={{__html: team.pageDesc.subtitle}} />
								</h2>
								<Link className="onovo-btn onovo-hover-btn mt-5" href="/team">
									<i className="arrow ms-2">
										<span />
									</i>
						...
						{team.team.slice(0, 2).map((item, key) => (
										...
										<div className="onovo-social-2">
											<ul>
												...
												<li key={`team2-item-${key}-social-${social_key}`}>
													<a className="onovo-social-link onovo-hover-2" href={social.role} title={social.title} target="_blank">
